<template>
        <div class="fixed inset-0 flex items-center justify-center px-4 py-8 sm:px-6 scroll-y-auto">
            <!-- Background overlay -->
            ...
            <div class="z-50 relative w-full max-w-lg sm:max-w-xl md:max-w-2xl bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all">
                ...
                <!-- Form -->
                <form @submit.prevent="submitTransaction" class="p-6 sm:p-8">
                    <!-- Transaction Type -->
                    <div class="mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                min="0"
                                placeholder="0.00"
                                class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-[#226f54] focus:border-[#226f54] transition-colors"
...
const submitTransaction = () => {
    // Use Inertia's form submission (handles CSRF automatically)
